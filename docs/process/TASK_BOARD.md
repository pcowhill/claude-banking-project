...
## Milestone v0.8.0 — Cards, fraud, disputes  🚧 In Progress
...
> Later milestones (v0.9.0–v1.0.0) are summarized in `ROADMAP.md` and will be
> decomposed into tasks here when they become the active milestone. **v0.9.0**
> carries **recurring/scheduled payments** (`M-09`, deferred — needs the sim clock).
