...
**Current milestone:** `v0.6.1 — Operations console fixes` (a patch on
`v0.6.0 — Onboarding and account opening`; see `ROADMAP.md` and
`docs/process/MILESTONE_REPORT_v0.6.1.md`).
